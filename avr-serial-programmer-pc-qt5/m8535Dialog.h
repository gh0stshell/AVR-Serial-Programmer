/*
Title:    Atmel Microcontroller Serial Port FLASH loader. M8535 Lock/Fuse bits
*/
...
#ifndef M8535_DIALOG_H
#define M8535_DIALOG_H
...
//-----------------------------------------------------------------------------
/** @brief AVR Serial Programmer m8535 Type Lock/Fuse bit Dialogue

This class provides a dialogue window
*/

class M8535Dialog : public QDialog
{
    Q_OBJECT
public:
...
// User Interface object
    Ui::M8535Dialog m8535DialogFormUi;
};
