/*
@brief                        T261 Type Lock/Fuse bits
...
T261Dialog::T261Dialog(QSerialPort* p, QWidget* parent) : QDialog(parent)
{
    port = p;
...
void T261Dialog::setDefaults(uchar l, uchar e, uchar h, uchar f)
{
...
void T261Dialog::on_closeButton_clicked()
{
    reject();
}
...
void T261Dialog::on_lockWriteButton_clicked()
{
...
void T261Dialog::on_memoryLockBox_currentIndexChanged(int memoryLock)
{
    if (memoryLock != 0)
    {
...
void T261Dialog::on_extFuseWriteButton_clicked()
{
    uchar extFuseBits = 0;
...
void T261Dialog::on_highFuseWriteButton_clicked()
{
    ...
    if (!t261DialogFormUi.preserveEEPROMBox->isChecked()) highFuseBits+=0x08;
    ...
    if (!t261DialogFormUi.debugWIREBox->isChecked()) highFuseBits+=0x40;
    if (!t261DialogFormUi.resetDisableBox->isChecked()) highFuseBits+=0x80;
...
void T261Dialog::on_fuseWriteButton_clicked()
{
    uint fuseBits = 0;
