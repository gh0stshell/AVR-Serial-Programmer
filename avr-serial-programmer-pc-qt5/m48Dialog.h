/*
Title:    Atmel Microcontroller Serial Port FLASH loader. M48 Lock/Fuse bits
*/
...
class M48Dialog : public QDialog
{
    Q_OBJECT
public:
    M48Dialog(QSerialPort*, QWidget* parent = 0);
    ~M48Dialog();
