/*
Title:    Atmel Microcontroller Serial Port FLASH loader. M16 Lock/Fuse bits
*/
...
//-----------------------------------------------------------------------------
/** @brief AVR Serial Programmer m16 Type Lock/Fuse bit Dialogue

This class provides a dialogue window
*/

class M16Dialog : public QDialog
{
    Q_OBJECT
public:
